...
class LLMTaskPlanner:
    ...
    def __init__(
        ...
        self._chain = PLANNER_PROMPT | structured_model
    ...
    async def plan(
        ...
        if not isinstance(
            ...
            raise TypeError(f"LLM Planner 返回了非预期的结构化结果：{type(decision).__name__}")
        ...
        logger.info(
            "LLM Planner produced task plan: tasks=%s requested_output=%s prompt_version=%s",
            plan.tasks,
