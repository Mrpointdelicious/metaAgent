...
def build_analytics_tools(analytics_service: AnalyticsService) -> list[ToolSpec]:
    ...
    return [
        ToolSpec(
            ...
            description="Return the patients actually seen by a doctor inside a window, including patient_name when available.",
            input_model=DoctorWindowInput,
            output_schema="PatientSet JSON with patient_ids, patients, and patient_names",
            chain_scope="A",
        ...
        ToolSpec(
            ...
            description="Return the patients with plans for a doctor inside a window, including patient_name when available.",
            input_model=DoctorWindowInput,
            output_schema="PatientSet JSON with patient_ids, patients, and patient_names",
            chain_scope="A",
            can_affect_risk_score=False,
        ...
        ToolSpec(
            ...
            description="Return doctor-level active plan aggregates inside a window, including doctor_name when available.",
            input_model=DateWindowInput,
            output_schema="DoctorAnalyticsResultRow[] JSON with doctor_name",
            chain_scope="A",
            can_affect_risk_score=False,
        ...
        ToolSpec(
            ...
            description="Return the latest visit metadata for a patient, including patient_name and doctor_name when available.",
            input_model=LastVisitInput,
            output_schema="LastVisitInfo JSON with patient_name and doctor_name",
            chain_scope="A",
            can_affect_risk_score=False,
        ...
        ToolSpec(
            ...
            description="Return whether a patient has plans in a window, including patient_name and doctor_name when available.",
            input_model=PatientPlanStatusInput,
            output_schema="PlanStatus JSON with patient_name and doctor_name",
            chain_scope="A",
            can_affect_risk_score=False,
        ...
        ToolSpec(
            ...
            description="Rank patients with a deterministic strategy, including patient_name when available.",
            input_model=RankPatientsInput,
            output_schema="RankedPatients JSON with patient_name",
            chain_scope="A",
            can_affect_risk_score=False,
